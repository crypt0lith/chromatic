...
class colorbytes(bytes):
    ...
    @property
    def rgb_dict[_KT: (L['fg'], L['bg'])](self) -> mappingproxy[_KT, Int3Tuple]: ...
...
class SgrParamBuffer[_T: (bytes, ansicolor4Bit, ansicolor8Bit, ansicolor24Bit)]:
    ...
    def __eq__(self, other, /) -> tp.TypeIs[SgrParamBuffer[_T] | _T]: ...
    def __hash__(self) -> int: ...
    def __init__(self, value: SgrParamBuffer[_T] | _T = ..., /) -> None: ...
    @property
    def value(self) -> _T: ...
