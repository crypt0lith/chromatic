...
class Color(int):
    @classmethod
    def from_rgb(cls, rgb: RGBVectorLike, /) -> Self: ...
    ...
    @overload
    def __new__(
        cls, x: str | bytes | bytearray, /, base: SupportsIndex = 10
    ) -> Self: ...
...
class colorbytes(bytes):
    @classmethod
    @overload
    def from_rgb[_T, _KT: (L['bg'], L['fg']), _VT: (SupportsInt, RGBVectorLike)](
        cls: type[_T], rgb: tuple[ColorDictKeys, _VT] | Mapping[_KT, _VT], /
    ) -> _T: ...
    @classmethod
    @overload
    def from_rgb[_T, _VT: (SupportsInt, RGBVectorLike)](
        cls: type[_T], rgb: tuple[str, _VT] | Mapping[str, _VT], /
    ) -> _T: ...
    ...
    @property
    def rgb_dict[_KT: (L['fg'], L['bg'])](self) -> MappingProxyType[_KT, Int3Tuple]: ...

class ColorStr(str):
    def _weak_var_update(self, **kwargs: Unpack[_ColorStrWeakVars]) -> Self: ...
    def ansi_partition(self) -> TupleOf3[str]: ...
    def as_ansi_type(self, ansi_type: AnsiColorParam, /) -> Self: ...

    @overload
    def recolor(self, value: ColorStr, /, *, absolute: bool = ...) -> Self: ...
    @overload
    def recolor(self, **kwargs: Unpack[_RecolorKwargs]) -> Self: ...

    def strip_style(self) -> Self: ...
    def add_reset(self) -> Self: ...
    def remove_reset(self) -> Self: ...
    def swap_reset(self) -> Self: ...
    def add_sgr_param(self, x: int, /) -> Self: ...
    def remove_sgr_param(self, x: int, /) -> Self: ...
    def blink(self) -> Self: ...
    ...
    def format_map(self, mapping: SupportsKeysAndGetItem[str, object], /) -> Self: ...
    def index(
        self,
        sub: str,
        start: SupportsIndex | None = ...,
    ...
    def ljust(self, width: SupportsIndex, fillchar=' ', /) -> Self: ...
    def lower(self) -> Self: ...
    def lstrip(self, chars: str | None = None, /) -> Self: ...
    def partition(self, sep: str, /) -> TupleOf3[Self]: ...
    ...
    def rjust(self, width: SupportsIndex, fillchar=' ', /) -> Self: ...
    def rpartition(self, sep: str, /) -> TupleOf3[Self]: ...
    def rsplit(
    ...
    def __new__[_RGBVectorLike: RGBVectorLike](
        ...
        obj: object = ...,
        /,
        fg: SupportsInt | _RGBVectorLike | None = None,
        bg: SupportsInt | _RGBVectorLike | None = None,
        *,
...
class color_chain(Sequence[tuple[SgrSequence, str]]):
    ...
    def _is_mask_seq(
        obj: object, /
    ) -> TypeGuard[Sequence[tuple[SgrSequence, str]]]: ...
    @classmethod
    def _from_masks_unchecked(
        cls,
        masks: Iterable[tuple[SgrSequence, str]],
        /,
    ...
    def from_masks(
        ...
        /,
        ansi_type: type[AnsiColorFormat] | None = None,
    ) -> Self: ...
...
class SgrParamBuffer[_T: (bytes, ansicolor4Bit, ansicolor8Bit, ansicolor24Bit)]:
    def is_color(self) -> bool: ...
    def is_reset(self) -> bool: ...
    def __buffer__(self, flags: int, /) -> memoryview: ...
    def __bytes__(self) -> bytes: ...
    def __eq__(self, other, /) -> TypeIs[SgrParamBuffer[_T] | _T]: ...
    def __hash__(self) -> int: ...

    @overload
    def __new__(cls, value: _T = ..., /) -> Self: ...
    @overload
    def __new__(cls, value: SgrParamBuffer[_T], /) -> Self: ...
...
class SgrSequence(MutableSequence[SgrParamBuffer]):
    class _color_descriptor:
        ...
        def __set__(self, inst, value: Int3Tuple | None, /): ...
    ...
    def set_colors(
        self,
        iterable: Iterable[tuple[ColorDictKeys, Int3Tuple | None]],
        /,
        ansi_type=DEFAULT_ANSI,
    ): ...
    ...
    def copy(self) -> Self: ...
    def insert(self, index: SupportsIndex, value: bytes | SgrParamBuffer, /): ...
    def extend(self, iterable: bytes | bytearray | Iterable[Buffer], /): ...
    ...
    @overload
    def __getitem__(self, index: SupportsIndex, /) -> SgrParamBuffer: ...
    @overload
    def __getitem__(self, index: slice, /) -> list[SgrParamBuffer]: ...

    @overload
    def __setitem__(self, index: SupportsIndex, value: bytes | SgrParamBuffer, /): ...
    @overload
    def __setitem__(self, index: slice, value: Iterable[bytes | SgrParamBuffer], /): ...
